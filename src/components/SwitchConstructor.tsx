...
const SwitchConstructor: FC = () => {
  ...
  return (
    <div className="sidebar-switch">
      <div className="sidebar-switch__content">
        <div
          onClick={() => dispatch(setRunTime(true))}
          className={`constructor-items__runtime ${runtime ? 'active' : ''}`}>
          <svg
            width="20"
            height="20"
            viewBox="0 0 20 20"
        ...
        <div
          ...
          className={`constructor-items ${!runtime ? 'active' : ''}`}>
          <svg
            width="20"
            height="20"
            viewBox="0 0 20 20"
...
export default SwitchConstructor;
